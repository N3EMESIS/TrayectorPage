    ...
    <div className="LoginFormContainer">
      <form className="LoginForm" onSubmit={handleSubmit}>
        <div className="LoginFormInput">
          ...
          />
          {!validEmail && (
            <span className="ErrorMessage">Correo electrónico inválido</span>
          )}
        </div>
        ...
        <div className="LoginFormOr">or</div>

        <button className="LoginFormGoogleButton" onClick={SignInWithGoogle}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            preserveAspectRatio="xMidYMid"
            viewBox="0 0 256 262"
            className="LoginFormGoogleLogo"
          >
            <path
              fill="#4285F4"
          ...
          <span className="LoginFormGoogleSpan">Continue with Google</span>
        </button>

        <div className="LoginFormForgotPassword">
          <NavLink to={"/ResetPass"} className="LoginFormResetPassLink">
