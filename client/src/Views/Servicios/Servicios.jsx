            ...
            <div className={styles.container}>
                <div className={styles.separator1}>
                    ...
                    <div className={styles.bg1}>
                        <img className={styles.image1} src={dinero} alt='dinero' width='400px' height='400px' />
                    </div>
                </div>
                <div className={styles.separator2}>
                    ...
                    <div className={styles.bg2}>
                        <img className={styles.image2} src={dinero} alt='dinero' width='400px' height='400px' />
                    </div>
                </div>
                <div className={styles.separator3}>
                    ...
                    <div className={styles.bg3}>
                        <img className={styles.image3} src={dinero} alt='dinero' width='400px' height='400px' />
                    </div>
                </div>
                ...
                <div className={styles.separator4}>
                    ...
                    <div className={styles.bg4}>
                        <img className={styles.image4} src={dinero} alt='dinero' width='400px' height='400px' />
                    </div>
                </div>
                <div className={styles.separator5}>
                    ...
                    <div className={styles.bg5}>
                        <img className={styles.image5} src={dinero} alt='dinero' width='400px' height='400px' />
                    </div>
                </div>
            </div>
        </div>
